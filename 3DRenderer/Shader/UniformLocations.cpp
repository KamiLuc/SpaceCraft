...
UniformLocations::UniformLocations() : uniformModel(-1), uniformProjection(-1), uniformView(-1), uniformAmbientColor(-1), uniformAmbientIntensity(-1), uniformCameraPosition(-1),
